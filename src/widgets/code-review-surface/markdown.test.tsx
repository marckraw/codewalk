...
describe("MarkdownText", () => {
  ...
  it("renders links that open safely in a new tab", () => {
    render(<MarkdownText content="see [the PR](https://github.com/ef-global/backpack/pull/1)" />);

    const link = screen.getByRole("link", { name: "the PR" });
    expect(link).toHaveAttribute("href", "https://github.com/ef-global/backpack/pull/1");
