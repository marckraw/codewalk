...
export function Panel({ as: Component = "section", className, ...props }: PanelProps) {
  return (
    <Component
      className={cn("rounded-md border border-[var(--border)] bg-[var(--panel)]", className)}
      {...props}
    />
  );
}
...
export function PanelHeader({ actions, className, description, title, ...props }: PanelHeaderProps) {
  return (
    <div
      className={cn(
