...
export function GuideFileDiff({ diff, file, loading, renderRef }: GuideFileDiffProps) {
  return (
    <article ref={renderRef} className="min-w-0 scroll-mt-5 border border-border bg-card">
